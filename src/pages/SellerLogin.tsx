...
const SellerLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (userData?.user) {
      const { data: hasSellerRole } = await supabase.rpc('has_role', { _user_id: userData.user.id, _role: 'seller' as any });
    ...
    setLoading(false);
    toast({ title: "Welcome, Seller!", description: "Redirecting to your dashboard..." });
    navigate('/seller');
  };
      ...
      <main className="container mx-auto px-4 py-8 flex items-center justify-center min-h-[60vh]">
        <Card className="w-full max-w-md shadow-elevated animate-fade-in">
          <CardHeader className="text-center">
            ...
            <CardTitle className="font-serif text-2xl">Seller Login</CardTitle>
